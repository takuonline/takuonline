...
**Founding ML Engineer @ Takuonline**

I build production AI systems end-to-end. Model development, infrastructure, deployment—solo or leading teams.

Cape Town | [takuonline.com](https://www.takuonline.com) | [LinkedIn](https://www.linkedin.com/in/takudzwa-makusha/)
...
[Backend](https://github.com/takuonline/google_lens_clone_backend) · [Mobile](https://github.com/takuonline/google_lens_clone_mobile)

`Python` `Flutter` `PyTorch` `Computer Vision`

Computer vision system with image recognition and product search. Trained custom models for visual similarity matching.
...
Distributed crawlers for e-commerce data collection. Built to handle rate limits, CAPTCHAs, and scale to thousands of products daily.

- [Shoprite Spider](https://github.com/takuonline/savvy_shoprite_spider)
- [PC Components Spider](https://github.com/takuonline/savvy_pc_components_spider)
...
Three iterations of portfolio development.

- [V1 repo](https://github.com/takuonline/portfolio_website_v1) | [website](https://v1.takuonline.com) `HTML` `CSS`
- [V2 repo](https://github.com/takuonline/portfolio_website_v2) | [website](https://v2.takuonline.com) `HTML` `CSS`
- [V3 repo](https://github.com/takuonline/portfolio_website_v3) | [website](https://v3.takuonline.com) `HTML` `CSS` `JavaScript`
- V4(not open sourced) | [website](https://v4.takuonline.com) `Nextjs`
- V5(not open sourced) | [website](https://v5.takuonline.com) `Nextjs`
...
[LinkedIn](https://www.linkedin.com/in/takudzwa-makusha/) · [Website](https://www.takuonline.com)
